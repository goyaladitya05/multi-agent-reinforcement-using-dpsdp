...
#the actor learns to predict the refined_answer
...
#the critic learns to predict the feedback
...
actor_trainer.train()
actor_trainer.save_model("./sft_actor")
...
critic_trainer.save_model("./sft_critic")
